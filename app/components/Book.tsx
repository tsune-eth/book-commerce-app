    ...
    <>
      ...
      <div className="flex flex-col items-center m-4">
        <a 
          ...
          />
          <div className="px-4 py-4 bg-slate-100 rounded-b-md w-[250px]">
            <h2 className="text-lg font-semibold whitespace-pre-wrap">{book.title}</h2>
            <p className="mt-2 text-md text-slate-600">「{book.description}」</p>
        ...
        { showModal && (
          ...
          <div className="bg-white p-8 rounded-lg">
            ...
            <h6><b className="text-blue-600">{book.title}</b></h6>
